...
import { ESCROW_DAPP_PROGRAM_ADDRESS } from '../programs';
...
export type GreetInstruction<
  TProgram extends string = typeof ESCROW_DAPP_PROGRAM_ADDRESS,
...
export function getGreetInstruction<
  TProgramAddress extends Address = typeof ESCROW_DAPP_PROGRAM_ADDRESS,
>(config?: {
  programAddress?: TProgramAddress;
}): GreetInstruction<TProgramAddress> {
  // Program address.
  const programAddress = config?.programAddress ?? ESCROW_DAPP_PROGRAM_ADDRESS;
